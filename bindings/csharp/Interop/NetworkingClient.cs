...
namespace GameNetworkingSockets
{
    ...
    public class NetworkingClient : NetworkingSockets
    {
        ...
        /// through your own signaling server, use <see cref="ConnectP2PCustomSignaling"/> instead.
        /// </summary>
        ...
        /// (<c>ISteamNetworkingConnectionSignaling*</c>). The shim forwards ICE rendezvous messages
        /// over an application-provided signaling channel (e.g. a lobby server connection).
        ...
        /// tagged union; for platform-independent signaling set it via
        /// <c>SteamAPI_SteamNetworkingIdentity_SetGenericString</c> to any label you choose
